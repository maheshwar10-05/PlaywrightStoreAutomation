...
from playwrightTestingPractice.pageobjects.absolue_eye_special import AbolueEye
...
def test_input_quantity_special(browserInstance,common_steps,login_fixture):
    ...
    absolue_prod_eye=AbolueEye(browserInstance)
    
    total_price,single_price,updated_quantity=absolue_prod_eye.input_quantity_special()
