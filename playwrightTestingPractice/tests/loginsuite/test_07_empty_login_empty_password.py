...
from playwrightTestingPractice.testdata.testdata_file import empty_login_empty_password

@pytest.mark.no_auth
async def test_correct_login_empty_password(browserInstance,click_login_register_button):
    loginobj=Login(browserInstance)
    error_message=await loginobj.enter_empty_login_empty_password(empty_login_empty_password)
