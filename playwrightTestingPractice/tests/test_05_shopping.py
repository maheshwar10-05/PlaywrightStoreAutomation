...
def test_shoppingcart_page(browserInstance,home_fixture):
...
def test_remove_product(browserInstance,home_fixture):
    home_fixture.cart_link()
    shop_obj=Shoppingcart(browserInstance)
    shop_obj.remove_product_from_cart()
def test_extract_cart_detail(browserInstance,home_fixture):
    home_fixture.cart_link()
    shop_obj=Shoppingcart(browserInstance)
    shop_obj.extract_shopping_cart_details()

def test_update_quantity(browserInstance,home_fixture):
    home_fixture.cart_link()
    shop_obj=Shoppingcart(browserInstance)
    total,calculate=shop_obj.update_quantity_calculate()
    assert calculate in total

def test_total_calculation(browserInstance,home_fixture):
    home_fixture.cart_link()
    shop_obj=Shoppingcart(browserInstance)
    uitotal,cal_total=shop_obj.consolidated_total()
    assert uitotal==cal_total

def test_orderconfirmation_page(browserInstance,home_fixture):
    home_fixture.cart_link()
    shop_obj=Shoppingcart(browserInstance)
